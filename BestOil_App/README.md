...
<br>**Требования к поставленной задаче:**
<br>Для удобства окно разделено на три части: первая для осуществления вычислений, касающихся непосредственно заправки автомобилей топливом; вторая – покупки в мини-кафе; третья часть для вычисления суммы оплаты.
<br>**Итак, первая группа элементов Автозаправка.
